(function() {
  ...
  e = ["debug", "angular", "core/module", "core/services/generate"], r = function(e, r) {
    ...
    return tele = function($rootScope, $q, $timeout, generate) {
      ...
      return k = generate.randomId(8), c = e("tele [" + k + "]"), i = e("tele [" + k + "]"), i.log = console.error.bind(console), l = {}, p = {}, f = function(e, r) {
        var n;
        return n = {
          senderId: k,
        ...
        var t, o, s, u, i, d, l, a, c, f, m;
        for (a = n.old, s = 0, d = a.length; d > s; s++)
          for (o = a[s], t = u = c = e.length - 1; 0 >= c ? 0 >= u : u >= 0; t = 0 >= c ? ++u : --u) r.equals(e[t], o) && e.splice(t, 1);
