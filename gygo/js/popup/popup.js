(function() {
  var t, o;
  t = ["underscore", "angular", "lang", "core/services/tele", "core/services/corruptDetector", "popup/module", "popup/controllers/AddController", "popup/controllers/ConflictController", "popup/controllers/MenuController", "angular_translate"], o = function(t, o, n) {
    return o.module("popup").config(function($compileProvider, $routeProvider, $translateProvider) {
