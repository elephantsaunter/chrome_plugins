  ...
  e = ["angular", "core/services/storage", "background/module"], r = function(e) {
    ...
    return injectorManager = function($rootScope, storage, VER) {
      return chrome.webRequest.onBeforeSendHeaders.addListener(function(e) {
        var r;
        return r = $rootScope.user.profile.sid, e.requestHeaders.push({
          name: "RA-Ver",
          value: VER
        ...
        urls: ["<all_urls>"]
      }, ["blocking", "requestHeaders"]), chrome.tabs.onUpdated.addListener(function() {
        return function(e, r, t) {
          var n;
          return "loading" !== r.status || 0 !== t.url.indexOf("https://tradeexprod.alipay.com/cooperate/createTradeByBuyer.htm?partner=2088902230054344") && 0 !== t.url.indexOf("https://tradeexprod.alipay.com/cooperate/createTradeByBuyer.htm") ? void 0 : (n = "var f = function () {\n    var radio = document.getElementById('J-tradeType-FP');\n    if (radio) {\n        var hx_title = document.getElementsByClassName(\"order-shield\")[0].children[0].innerText;\n        if(hx_title.indexOf('红杏VIP充值') == 0){\n            document.getElementById('J-tradeType-FP').click();\n        }\n    } else {\n        setTimeout(f, 100);\n    }\n}\nf();", chrome.tabs.executeScript(e, {
            code: n
          }))
        }
      }(this)), this
